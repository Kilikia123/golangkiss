...
const (
	...
	BlogService_UnlikePost_FullMethodName = "/blog.v1.BlogService/UnlikePost"
)
...
type BlogServiceClient interface {
	...
	UnlikePost(ctx context.Context, in *UnlikePostRequest, opts ...grpc.CallOption) (*Empty, error)
}
...
func (c *blogServiceClient) DeletePost(ctx context.Context, in *DeletePostRequest, opts ...grpc.CallOption) (*Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Empty)
...
func (c *blogServiceClient) LikePost(ctx context.Context, in *LikePostRequest, opts ...grpc.CallOption) (*Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Empty)
...
func (c *blogServiceClient) UnlikePost(ctx context.Context, in *UnlikePostRequest, opts ...grpc.CallOption) (*Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Empty)
...
type BlogServiceServer interface {
	...
	UnlikePost(context.Context, *UnlikePostRequest) (*Empty, error)
...
func (UnimplementedBlogServiceServer) DeletePost(context.Context, *DeletePostRequest) (*Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method DeletePost not implemented")
}
func (UnimplementedBlogServiceServer) LikePost(context.Context, *LikePostRequest) (*Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method LikePost not implemented")
}
func (UnimplementedBlogServiceServer) UnlikePost(context.Context, *UnlikePostRequest) (*Empty, error) {
